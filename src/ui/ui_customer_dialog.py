...
# Form implementation generated from reading ui file '/home/trungkieen/project/hotel-booking-system/src/ui/ui_customer_dialog.ui'
#
...
class Ui_CustomerDialog(object):
    def setupUi(self, CustomerDialog):
        ...
        self.buttonBox.rejected.connect(CustomerDialog.reject) # type: ignore
    ...
    def retranslateUi(self, CustomerDialog):
        ...
        self.firstNameLabel.setText(_translate("CustomerDialog", "First Name"))
        self.lastNameLabel.setText(_translate("CustomerDialog", "Last Name"))
        self.addressLabel.setText(_translate("CustomerDialog", "Address"))
        self.birthLabel.setText(_translate("CustomerDialog", "Birth"))
        self.genderLabel.setText(_translate("CustomerDialog", "Gender"))
        self.gender.setItemText(0, _translate("CustomerDialog", "Male"))
