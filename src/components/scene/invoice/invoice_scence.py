...
from components.scene.invoice.dialog.detail_dialog import InvoiceDetailDialog
from components.scene.invoice.dialog.filter_dialog import InvoiceFilterDialog
from components.scene.invoice.invoice_adapter import InvoiceAdapter
