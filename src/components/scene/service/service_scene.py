...
from components.scene.service.dialog.create_service_dialog import CreateServiceDialog
from components.scene.service.dialog.edit_dialog import EditServiceDialog
